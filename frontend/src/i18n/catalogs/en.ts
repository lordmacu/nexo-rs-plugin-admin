...
const en = {
  ...
  "channels.action.approve": "Approve",
  "channels.approve.title": "Approve channel",
  "channels.approve.agent_label": "Agent",
  "channels.approve.agent_placeholder": "(pick one)",
  "channels.approve.server_label": "MCP server",
  "channels.approve.server_placeholder": "e.g. plugin:telegram:tg",
  "channels.approve.server_hint": "Lists servers in mcp.yaml; also accepts plugin-shipped names (telegram, whatsapp, …).",
  "channels.approve.allowlist_label": "Allowed bindings (optional)",
  "channels.approve.allowlist_hint": "Comma-separated indices (0, 2, 5). Empty = all agent bindings.",
  "channels.approve.allowlist_invalid": "Only positive integers separated by commas.",
  "channels.approve.action": "Approve",
  "channels.approve.saving": "Saving…",
  "channels.approve.cancel": "Cancel",
  ...
  "tenants.action.create": "Create",
  "tenants.action.reload": "Reload",
  "tenants.action.activate": "Activate",
  "tenants.action.deactivate": "Deactivate",
  "tenants.action.activate_confirm": "Activate tenant \"{name}\"?",
  "tenants.action.deactivate_confirm": "Deactivate tenant \"{name}\"? Agents tied to it will stop serving traffic.",
  "tenants.action.delete": "Delete",
  "tenants.delete.confirm": "Delete tenant \"{name}\"?",
  "tenants.delete.purge_confirm": "{count} agents reference \"{name}\" (e.g. {agents}). Delete tenant AND agents?",
  "tenants.create.title": "Create tenant",
  "tenants.create.id_label": "ID (kebab-case)",
  "tenants.create.id_problem": "Lowercase letters, digits, and dashes only (max 64 chars).",
  "tenants.create.name_label": "Name",
  "tenants.create.action": "Create",
  "tenants.create.saving": "Creating…",
  ...
  "memory.snapshots.empty": "No snapshots for this agent. Capture one via the “+ Create snapshot” button or `agent memory snapshot --agent <id>` on the CLI.",
  "memory.snapshots.error": "Could not list snapshots: {message}",
  "memory.snapshots.more": "and {count} more…",
  "memory.snapshots.show_all": "Show {count} more",
  "memory.snapshots.collapse": "Collapse",
  "memory.snapshots.delete": "Delete snapshot",
  "memory.snapshots.delete_confirm": "Delete snapshot {id}…? The bundle is removed from disk; future restores require a different snapshot.",

  // Phase 90.x.memory-snapshot.create-restore — capture modal.
  "memory.snapshots.create.title": "Create snapshot",
  "memory.snapshots.create.action": "Create snapshot",
  "memory.snapshots.create.label_label": "Label (optional)",
  "memory.snapshots.create.label_placeholder": "pre-deploy",
  "memory.snapshots.create.label_hint": "Stored in the bundle manifest. Useful as a milestone marker.",
  "memory.snapshots.create.encrypt_label": "Encrypt with age",
  "memory.snapshots.create.encrypt_hint": "Bundle body wrapped with the operator-configured age recipient.",
  "memory.snapshots.create.encrypt_disabled_hint": "No recipient configured in memory.snapshot.encryption.recipients.",
  "memory.snapshots.create.cancel": "Cancel",
  "memory.snapshots.create.saving": "Saving…",

  // Phase 90.x.memory-snapshot.create-restore — restore modal.
  "memory.snapshots.restore.title": "Restore snapshot",
  "memory.snapshots.restore.action": "Restore",
  "memory.snapshots.restore.preview_action": "Preview (dry run)",
  "memory.snapshots.restore.previewing": "Previewing…",
  "memory.snapshots.restore.preview_done_hint": "Preview done — review and confirm below.",
  "memory.snapshots.restore.apply_action": "Apply destructively",
  "memory.snapshots.restore.applying": "Applying…",
  "memory.snapshots.restore.cancel": "Cancel",
  "memory.snapshots.restore.warning": "Restore overwrites the agent's live memory state. The daemon will auto-capture a pre-restore snapshot first so the operation is reversible.",
  "memory.snapshots.restore.confirm_prompt": "Type `{prefix}` to confirm.",
  "memory.snapshots.restore.encrypted_note": "This bundle is encrypted; the daemon will decrypt with the configured identity file.",
  "memory.snapshots.restore.report_title_preview": "Restore preview (dry run)",
  "memory.snapshots.restore.report_title_applied": "Restore applied",
  "memory.snapshots.restore.done_title": "Restore complete",
  "memory.snapshots.restore.done_intro": "The pre-restore snapshot was captured automatically and is available in the snapshot list — use it to roll back if needed.",
  "memory.snapshots.restore.close": "Close",
  "memory.snapshots.restore.field.snapshot_id": "Snapshot ID",
  "memory.snapshots.restore.field.tenant": "Tenant",
  "memory.snapshots.restore.field.label": "Label",
  "memory.snapshots.restore.field.from_snapshot_id": "Restored from",
  "memory.snapshots.restore.field.pre_snapshot_id": "Pre-restore snapshot",
  "memory.snapshots.restore.field.git_reset_oid": "Git HEAD reset to",
  "memory.snapshots.restore.field.workers_restarted": "Workers restarted",
  "memory.snapshots.restore.field.sqlite_restored_dbs": "SQLite databases restored",
  "memory.snapshots.restore.field.state_files_restored": "State files restored",
  ...
  "plugins.summary.invalid": "Invalid",
  "plugins.summary.disabled": "Disabled",
  "plugins.summary.duplicates": "Duplicates",
  "plugins.unmet_required.title": "Unmet required capabilities",
  "plugins.contributions.title": "Plugin contributions",
  "plugins.contributions.agents": "Contributed agents",
  "plugins.contributions.skills": "Contributed skills",
  "plugins.contributions.empty": "None",
  "plugins.capability_gates.title": "Plugin capability gates",
  "plugins.loaded.title": "Active plugins",
  ...
  "plugins.restart.report.banner": "Restart applied to `{plugin_id}`",
  "plugins.restart.report.previous_uptime": "Previous uptime: {ms} ms",
  "plugins.restart.report.new_pid": "New PID: {pid}",
  "plugins.restart.report.restarted_at": "At {ts}",
  "plugins.restart.report.dismiss": "Dismiss",
