...
const es = {
  ...
  "channels.action.approve": "Aprobar",
  "channels.approve.title": "Aprobar canal",
  "channels.approve.agent_label": "Agente",
  "channels.approve.agent_placeholder": "(elige uno)",
  "channels.approve.server_label": "Servidor MCP",
  "channels.approve.server_placeholder": "p.ej. plugin:telegram:tg",
  "channels.approve.server_hint": "Lista los servidores en mcp.yaml; también acepta nombres plugin-shipped (telegram, whatsapp, …).",
  "channels.approve.allowlist_label": "Bindings permitidos (opcional)",
  "channels.approve.allowlist_hint": "Índices separados por comas (0, 2, 5). Vacío = todos los bindings del agente.",
  "channels.approve.allowlist_invalid": "Sólo enteros positivos separados por comas.",
  "channels.approve.action": "Aprobar",
  "channels.approve.saving": "Guardando…",
  "channels.approve.cancel": "Cancelar",
  ...
  "tenants.action.create": "Crear",
  "tenants.action.reload": "Actualizar",
  "tenants.action.activate": "Activar",
  "tenants.action.deactivate": "Desactivar",
  "tenants.action.activate_confirm": "¿Activar la empresa «{name}»?",
  "tenants.action.deactivate_confirm": "¿Desactivar la empresa «{name}»? Los agentes ligados dejarán de servir tráfico.",
  "tenants.action.delete": "Eliminar",
  "tenants.delete.confirm": "¿Eliminar la empresa «{name}»?",
  "tenants.delete.purge_confirm": "{count} agentes referencian «{name}» (ej. {agents}). ¿Eliminar empresa Y agentes?",
  "tenants.create.title": "Crear empresa",
  "tenants.create.id_label": "ID (kebab-case)",
  "tenants.create.id_problem": "Sólo letras minúsculas, dígitos y guiones (max 64 chars).",
  "tenants.create.name_label": "Nombre",
  "tenants.create.action": "Crear",
  "tenants.create.saving": "Creando…",
  ...
  "memory.subtitle": "Consulta la memoria long-term de un agente. Sin agent_id la búsqueda no se ejecuta. Snapshot creation sigue siendo CLI-only por ahora.",
  "memory.field.agent_id": "Agent ID",
  "memory.field.query": "Búsqueda",
  "memory.field.query_placeholder": "vacío = entradas más recientes",
  "memory.action.search": "Buscar",
  "memory.action.searching": "Buscando…",
  "memory.empty.body": "Sin resultados. Ingresa un agent_id e (opcionalmente) un query.",
  "memory.snapshots.title": "Snapshots",
  "memory.snapshots.empty": "Sin snapshots para este agente. Crea uno con el botón “+ Crear snapshot” o `agent memory snapshot --agent <id>` en CLI.",
  "memory.snapshots.error": "No se pudo listar snapshots: {message}",
  "memory.snapshots.more": "y {count} más…",
  "memory.snapshots.show_all": "Ver {count} más",
  "memory.snapshots.collapse": "Contraer",
  ...
  // Phase 90.x.memory-snapshot.create-restore — modal de captura.
  "memory.snapshots.create.title": "Crear snapshot",
  "memory.snapshots.create.action": "Crear snapshot",
  "memory.snapshots.create.label_label": "Etiqueta (opcional)",
  "memory.snapshots.create.label_placeholder": "pre-deploy",
  "memory.snapshots.create.label_hint": "Se guarda en el manifest del bundle. Útil como marca de hito.",
  "memory.snapshots.create.encrypt_label": "Encriptar con age",
  "memory.snapshots.create.encrypt_hint": "El bundle se envuelve con el recipient age configurado por el operador.",
  "memory.snapshots.create.encrypt_disabled_hint": "Sin recipient configurado en memory.snapshot.encryption.recipients.",
  "memory.snapshots.create.cancel": "Cancelar",
  "memory.snapshots.create.saving": "Guardando…",

  // Phase 90.x.memory-snapshot.create-restore — modal de restore.
  "memory.snapshots.restore.title": "Restaurar snapshot",
  "memory.snapshots.restore.action": "Restaurar",
  "memory.snapshots.restore.preview_action": "Vista previa (dry run)",
  "memory.snapshots.restore.previewing": "Generando vista previa…",
  "memory.snapshots.restore.preview_done_hint": "Vista previa lista — revisa y confirma abajo.",
  "memory.snapshots.restore.apply_action": "Aplicar (destructivo)",
  "memory.snapshots.restore.applying": "Aplicando…",
  "memory.snapshots.restore.cancel": "Cancelar",
  "memory.snapshots.restore.warning": "Restaurar sobrescribe el estado de memoria del agente. El daemon captura primero un snapshot pre-restore para que la operación sea reversible.",
  "memory.snapshots.restore.confirm_prompt": "Escribe `{prefix}` para confirmar.",
  ...
  "memory.snapshots.restore.field.from_snapshot_id": "Restaurado desde",
  "memory.snapshots.restore.field.pre_snapshot_id": "Snapshot pre-restore",
  "memory.snapshots.restore.field.git_reset_oid": "Git HEAD reseteado a",
  "memory.snapshots.restore.field.workers_restarted": "Workers reiniciados",
  "memory.snapshots.restore.field.sqlite_restored_dbs": "DBs SQLite restauradas",
  "memory.snapshots.restore.field.state_files_restored": "Archivos de estado restaurados",
  ...
  "plugins.summary.duplicates": "Duplicados",
  "plugins.unmet_required.title": "Capabilities requeridas no concedidas",
  "plugins.contributions.title": "Contribuciones del plugin",
  "plugins.contributions.agents": "Agentes contribuidos",
  "plugins.contributions.skills": "Skills contribuidas",
  "plugins.contributions.empty": "Ninguno",
  "plugins.capability_gates.title": "Gates de capability del plugin",
